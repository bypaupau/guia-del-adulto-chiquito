...
,
...

  {
    ...
    categoria: "cafe",
    coords: [43.364020, -5.851040],
    direccion: "C/ Uría 40, 33003",
    telefono: "985 21 27 32",
    horario: "De lunes a sábado de 9:00 a 21:00, domingos de 9:00 a 17:30",
    web: "https://www.ovetusconfiteria.com/",
    nota: "Más nueva que las dos anteriores y con tartas por encargo, por si cae un cumpleaños. La chincheta está en la de Uría 40, que es la que cae en pleno centro y la única que pudimos ubicar con coordenadas. Tienen más obradores: C/ Santa Susana 1, Plaza San Miguel 1 y C/ Valentín Masip 13.",
    fotos: [],
    verificado: "2026-08"
  },

  {
    ...
    categoria: "cafe",
    coords: [43.384192, -5.814787],
    direccion: "C/ Arroyo Vaqueros 11, 33011 (La Corredoria)",
    ...
    nota: "Abre a las siete de la mañana, que es justo lo que necesitas si tienes clase temprano. Es una cadena pequeña de Oviedo con varias tiendas: la del centro está en C/ Fernando Alonso 26 (El Campillín), y luego Ciudad Naranco (Ricardo Montes 25), La Florida (Pl. Gabino Díaz Merchán) y Arquitecto Tioda 2. La chincheta cae en la de La Corredoria porque es la única que aparece ubicada en OpenStreetMap: si vas a la del Campillín, tira del botón de Google Maps.",
...

  {
    ...
    categoria: "cafe",
    coords: [43.360257, -5.844311],
    direccion: "Plaza de la Constitución 11, 33009",
    telefono: "985 21 37 12",
    horario: "De lunes a viernes de 7:30 a 15:30 y de 18:00 a 20:30, sábados de 8:00 a 15:00 y de 18:00 a 20:30, domingos de 8:00 a 15:00",
    web: "https://www.lamaseradevetusta.es/",
    nota: "Está en plena plaza del Ayuntamiento, al lado del Fontán, así que cae de camino si bajas al mercado. Abre a las siete y media y tienen pan sin gluten.",
